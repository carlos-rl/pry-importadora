...
?>
<div class="panel crud-form" data-unique-hash="<?php echo $unique_hash; ?>">
    <div class="panel-body gc-container">
        <h3 class="title-hero">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="">
                        <?php echo form_open( $update_url, 'method="post" id="crudForm"  enctype="multipart/form-data" class="form-horizontal bordered-row"'); ?>
