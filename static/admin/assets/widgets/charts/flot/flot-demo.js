$(function() {
    ...
    a(), $(".stackControls button").click(function(b) {
        b.preventDefault(), g = "With stacking" == $(this).text() ? !0 : null, a()
    }), $(".graphControls button").click(function(b) {
        b.preventDefault(), h = -1 != $(this).text().indexOf("Bars"), i = -1 != $(this).text().indexOf("Lines"), j = -1 != $(this).text().indexOf("steps"), a()
    })
}), $(function() {
    function a() {
    ...
    function a(a, b) {
        return "<div style='font-size:12px; text-align:center; padding:5px; color:white;'>" + a + "<br/>" + Math.round(b.percent) + "%</div>"
    }
    for (var b = [{
            label: "Asia",
            data: 111963e4,
            color: getUIColor("info")
        }, {
            label: "Latin America",
            data: 69095e4,
            color: getUIColor("warning")
        }, {
            label: "Africa",
            data: 101296e4,
            color: getUIColor("danger")
        }, {
            label: "Oceania",
            data: 51e5,
            color: getUIColor("gray")
        }, {
            label: "Europe",
            data: 72708e4,
            ...
            label: "North America",
            data: 34412e4,
            color: getUIColor("success")
        }], c = [], d = Math.floor(5 * Math.random()) + 3, e = 0; d > e; e++) c[e] = {
        label: "Series" + (e + 1),
