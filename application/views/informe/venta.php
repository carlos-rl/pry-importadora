    ...
    <div id="sb-site">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="example-box-wrapper">
                                        ...
                                        <table class="table table-bordered table-hover" id="tab_logic">
                                            ...
                                            <tbody id="tbody_">
                                                <tr id='addr0'>
                                                    <td colspan="9" class="text-center">Seleccione un rango de fechas</td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
        ...
        $(function() {
            ...
            var tablaDatos = function(btn){
                $.ajax({
                    url: '<?= base_url() ?>venta/listarreporte',
                    type: 'POST',
                    data: {
                        'fechaf': fechaf,
                        'fechai':fechai,
                    ...
                    beforeSend: function () {
                        ...
                        $('#tbody_').html('<tr> <td colspan="9">Buscando datos <i class="fa fa-refresh fa-spin"></i></td>');
                    }
                }).done(function (data) {
                    btn.html('Aplicar');
                    ...
                    $('#tbody_').html('<tr> <td colspan="9">Error,  intente nuevamente</td>');
                });
            }
