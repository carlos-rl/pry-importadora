    ...
    <div id="sb-site">
                                        ...
                                        <table class="table table-bordered table-hover" id="tab_logic">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">Valor de la cuota</th>
                                            ...
                                            <tbody id="tbody_">
                                                <tr id='addr0'>
                                                    <td colspan="8" class="text-center">Seleccione un rango de fechas</td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
        ...
        $(function() {
            ...
            var tablaDatos = function(btn){
                $.ajax({
                    url: '<?= base_url() ?>credito/listarreporte',
                    type: 'POST',
                    data: {
                        'fechaf': fechaf,
                        'fechai':fechai,
                    ...
                    for(var i in data){
                        ...
                        html +='<td class="">'+(d.fechapagar).toUpperCase()+' </td>';
                        html +='<td class="">'+((d.nombres+' '+(d.apellidos==null?'':d.apellidos)).toUpperCase()+' - <small>'+(d.cedula==null?'':d.cedula).toUpperCase()+'</small>')+'</td>';
                        html +='<td class="">$ '+(d.valorabonado).toUpperCase()+'</td>';
                        html +='<td class="">$ '+(d.valorcuota).toUpperCase()+'</td>';
                        html +='<td class="">'+(d.estado == '1'?'Pagado':'No pagado').toUpperCase()+'</td>';
                        html +='<td class="">$ '+(d.valorcuota).toUpperCase()+'</td>';
                        html +='</tr>';
                        $("#tbody_").append(html);
                        total = total + parseFloat(d.valorcuota);
                    }
