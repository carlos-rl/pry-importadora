    ...
    <div id="sb-site">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-horizontal bordered-row">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Por proveedor</label>
                                        <div class="col-sm-9">
        ...
        $(function() {
            ...
            var tablaDatos = function(btn){
                $.ajax({
                    url: '<?= base_url() ?>compra/listarreporte',
                    type: 'POST',
                    data: {
                        'fechaf': fechaf,
                        'fechai':fechai,
                    ...
                    beforeSend: function () {
                        ...
                        $('#tbody_').html('<tr> <td colspan="10">Buscando datos <i class="fa fa-refresh fa-spin"></i></td>');
                    }
                }).done(function (data) {
                    btn.html('Aplicar');
                    ...
                    if(data.length < 1){
                        $('#tbody_').html('<tr> <td colspan="10">Ningún dato en la tabla</td>');
                    }
                    $('#modal_buscar').modal('hide');
                }).fail(function () {
                    $('#tbody_').html('<tr> <td colspan="10">Error,  intente nuevamente</td>');
                });
            }
            ...
            $('#exportar').click(function(){
                window.location= '<?= base_url() ?>compra/pdf?idproveedor='+$('#idproveedor').val()+'&fechai='+fechai+'&fechaf='+fechaf;
            });
